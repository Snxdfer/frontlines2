...
GetKey.MouseButton1Down:connect(function()
	...
	game.StarterGui:SetCore("SendNotification", {Title = "Key copied", Text = "the key was copied into your clipboard", Icon = "", Duration = 3})
end)
...
GuiRemoval.MouseButton1Down:connect(function()
	...
	game.StarterGui:SetCore("SendNotification", {Title = "bye bye!", Text = "ill see ya again i guess", Icon = "", Duration = 3})
end)
